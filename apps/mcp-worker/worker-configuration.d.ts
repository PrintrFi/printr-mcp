/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: e555c9659c7915b3a541f470d717417d)
...
interface __BaseEnv_Env {
	...
	PUBLIC_ORIGIN: "https://printr-mcp-remote-staging.printr.workers.dev" | "https://printr-mcp-remote.printr.workers.dev";
	ALLOWED_ORIGINS: "";
	MCP_OBJECT: DurableObjectNamespace<import("./src/index").PrintrMCP>;
	SIGNING_SESSION: DurableObjectNamespace<import("./src/index").SigningSessionDO>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "PrintrMCP" | "SigningSessionDO";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PRINTR_API_BASE_URL" | "PRINTR_APP_URL" | "PUBLIC_ORIGIN" | "ALLOWED_ORIGINS">> {}
}
